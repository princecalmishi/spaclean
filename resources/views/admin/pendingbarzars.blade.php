...
<li class="breadcrumb-item"><a href="">Pending Barzars</a>
</li>
            ...
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a class="btn btn-success btn-sm" href="{{route('approvebazar',$users->id)}}">Approve</a></td>
                        <td><a href="{{route('declinebazar',$users->id)}}" class="btn btn-danger btn-sm" href="">Decline</a></td>
                    </tr>  
                    @endforeach 
            </table>
