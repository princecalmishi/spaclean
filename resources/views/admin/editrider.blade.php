...
<li class="breadcrumb-item"><a href="">Update Rider</a>
</li>
...
<form action="{{ route('updateridernow') }}" method="post"  enctype="multipart/form-data">
    @csrf
  <input type="hidden" value="{{$rider->id}}" name="riderid">
<div class="form-group row">
<label class="col-sm-2 col-form-label"> Name</label>
<div class="col-sm-10">
<input type="text" value="{{ $rider->name }}" name="name" class="form-control form-control-round" placeholder="User Name">
</div>
</div>
<div class="form-group row">
<label class="col-sm-2 col-form-label"> Email </label>
<div class="col-sm-10">
<input type="text" name="email" value="{{ $rider->email }}" class="form-control form-control-round" placeholder="User Email">
</div>
</div>
<div class="form-group row">
<label class="col-sm-2 col-form-label"> Phone </label>
<div class="col-sm-10">
<input type="text" name="phone" value="{{ $rider->phone }}" class="form-control form-control-round" placeholder="Phone Number">
</div>
</div>
...
<div class="col-sm-10">
<input type="number" value="{{ $rider->national_id }}" name="national_id" class="form-control form-control-round" placeholder="National ID">
</div>
</div>
...
<div class="col-sm-10">
<input type="text" name="town" value="{{ $rider->town }}" class="form-control form-control-round" placeholder="Town">
</div>
</div>
...
<div class="col-sm-10">
<input type="text" name="plate_number" value="{{ $rider->plate_number }}" class="form-control form-control-round" placeholder="Plate Number">
</div>
</div>
...
<div class="col-sm-10">
<input type="text" name="color" value="{{ $rider->color }}" class="form-control form-control-round" placeholder="Color">
</div>
</div>
