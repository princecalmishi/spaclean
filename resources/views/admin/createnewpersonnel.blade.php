...
<div class="d-inline">
<h5>Create New Car Wash Personnel</h5>
</div>
</div>
</div>
<div class="col-lg-4">
...
<li class="breadcrumb-item"><a href="">New Car Wash Personnel</a>
</li>
...
<form method="POST" action="{{ route('createnewpersonnel')}}" enctype="multipart/form-data">
            @csrf
