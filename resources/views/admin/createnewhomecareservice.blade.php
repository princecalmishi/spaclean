...
<div class="d-inline">
<h5>Create New Homecare Service</h5>
</div>
</div>
</div>
<div class="col-lg-4">
...
<form method="POST" action="{{ route('createnewhomecareservicepost')}}" enctype="multipart/form-data">
            @csrf
...
<div class="col-sm-10">
<input type="text" name="desc" value="" class="form-control form-control-round" placeholder="Description">
</div>
</div>
