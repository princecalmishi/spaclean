        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('editslidespost') }}" enctype="multipart/form-data">
                        @csrf

                        <div class="form-group row">
                            <label for="name" class="col-md-4 col-form-label text-md-right">Heading	</label>
                            <div class="col-md-6">
                            <input id="head" value="{{$data->heading}}" type="text" class="form-control" name="head" required autofocus>
                            <input id="id" value="{{$data->id}}" type="hidden" class="form-control" name="id">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="SubHeading" value="{{$data->subheading}}" type="text" class="form-control" name="subhead" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea class="form-control"  name="desc" id="" cols="20" rows="10">{{$data->desc	}}</textarea>
                            </div>
                        </div>
