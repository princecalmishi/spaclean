...
<div class="d-inline">
<h5>List of Completed Car Bookings</h5>
</div>
</div>
</div>
<div class="col-lg-4">
...
<li class="breadcrumb-item"><a href="">Completed Car Bookings</a>
</li>
            ...
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    @endphp
                        ...
                        <!-- <td>@if($users->status == 'unpaid')<a class="btn btn-success btn-sm" href="{{route('makepayment2',$users->id)}}">Pay Now</a>@endif</td>
