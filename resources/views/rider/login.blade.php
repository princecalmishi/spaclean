...
<style>
        body {
            margin: 0;
            padding: 0;
            background-image: url('/storage/static/bp.jpg');
            ...
            <div class="row">
                ...
                <div class="col-sm-12"> 
                    ...
                    <!-- Authentication card start -->
                        <form class="md-float-material form-material" method="POST" action="{{ route('rider.login') }}">
                        @csrf
                            ...
                            <div class="auth-box card">
                                <div class="card-block">
                                    <div class="row m-b-20">
                                        <div class="col-md-12">
                                            <h3 class="text-center">Sign In as a Rider </a></h3>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <a href="{{route('rider.register')}}" class="btn btn-danger btn-md btn-block waves-effect waves-light text-center m-b-20">Create Rider Account</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
