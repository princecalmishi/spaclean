...
<span>{{ Auth::guard('rider')->user()->name }}</span>
...
<li class="{{ (request()->segment(1) == 'rider') ? 'active' : '' }}">
<a href="{{route('rider')}}" class="waves-effect waves-dark">
<span class="pcoded-micon"><i class="feather icon-home"></i></span>
<span class="pcoded-mtext">Rider Dashboard</span>
</a>
</li>

<li class="{{ (request()->segment(1) == 'pendingriderdelivery') ? 'active' : '' }}">
<a href="{{route('pendingriderdelivery')}}" class="waves-effect waves-dark">
...
<li class="{{ (request()->segment(1) == 'completeriderdelivery') ? 'active' : '' }}">
<a href="{{route('completeriderdelivery')}}" class="waves-effect waves-dark">
<span class="pcoded-micon"><i class="feather icon-briefcase"></i></span>
<span class="pcoded-mtext">Completed Deliveries</span>
</a>
</li>

<li class="{{ (request()->segment(1) == 'ridertransactions') ? 'active' : '' }}">
<a href="{{route('ridertransactions')}}" class="waves-effect waves-dark">
<span class="pcoded-micon"><i class="feather icon-briefcase"></i></span>
