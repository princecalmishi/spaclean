                        ...
                        <div class="auth-box card">
                            <div class="card-block">
                                <div class="row m-b-20">
                                    <div class="col-md-12">
                                        <h3 class="text-center txt-primary">Sign up OR <a class="btn btn-primary" href="{{route('rider.register')}}">Register as Rider</a> </h3>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <a href="{{route('login')}}" class="btn btn-primary btn-md btn-block waves-effect text-center m-b-20">Sign in now</a>
                                    </div>
                                </div>
                            </div>
                        </div>
