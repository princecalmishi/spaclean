                                                    ...
                                                    <div class="prod-item text-center">
                                                        <div class="prod-img">
                                                            ...
                                                            <a href="{{route('cardetail',$dataz->id)}}" class="hvr-shrink">
                                                                <img style="height:150px;" src="/storage/images/{{$dataz->cover_image}}" class="img-fluid o-hidden" alt="prod1.jpg">
                                                            </a>
                                                        ...
                                                        <div class="prod-info">
                                                            ...
                                                            <span class="prod-price"><i class="fa fa-dollar mr-2"></i>KES. </i>{{$dataz->price}}</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>       
